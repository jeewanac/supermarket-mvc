...
public class CustomerModel {
    ...
    public String toString() {
        return "CustomerModel" + "custID=" + getCustID() + ", title=" + getTitle() + ", name=" + getName() + ", dob=" + getDob() + ", salary=" + getSalary() + ", address=" + getAddress() + ", city=" + getCity() + ", province=" + getProvince() + ", zip=" + getZip() + '}';
    }
